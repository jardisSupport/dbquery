...
class DbUpdatePostgresTest extends TestCase
{
    ...
    public function testThrowsExceptionForOrderBy(): void
    {
        ...
        $this->expectExceptionMessage('ORDER BY is not supported in PostgreSQL UPDATE statements');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('LIMIT is not supported in PostgreSQL UPDATE statements');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('JOIN is not supported in PostgreSQL UPDATE statements');
