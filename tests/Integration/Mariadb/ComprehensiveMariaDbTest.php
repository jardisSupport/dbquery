...
namespace JardisSupport\DbQuery\Tests\Integration\Mariadb;
...
/**
 * Comprehensive MariaDB Integration Tests
 *
 * Tests all builder features against a real MariaDB database with rich test data.
 * From simple queries to complex multi-table JOINs, CTEs, subqueries, and JSON.
 *
 * MariaDB is 99% identical to MySQL. Notable difference: no FULL JOIN support.
 */
class ComprehensiveMariaDbTest extends TestCase
{
    private const DIALECT = 'mariadb';
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo = $this->db->getMariaDbConnection();
