...
/**
 * MySQL integration test for camelCase identifier auto-quoting (2026-08-10)
 *
 * camelCase columns referenced in WHERE/ORDER BY/GROUP BY/SELECT are emitted
 * backtick-quoted and must execute against a real MySQL server.
 */
class CamelCaseIdentifierMySqlTest extends TestCase
{
